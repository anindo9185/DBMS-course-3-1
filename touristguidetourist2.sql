...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2022 at 08:19 AM
...
--
CREATE DATABASE IF NOT EXISTS `touristguide` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `touristguide`;
...
CREATE TABLE `hotels` (
  ...
  `hotel_Description` varchar(40) DEFAULT NULL,
  `hotel_Rating` int DEFAULT NULL,
  `hotel_cost` int DEFAULT NULL
...
(1, 'hotel sarina', 'luxury', '01356435428', 'Dhaka', 'null', 'null', 'description not needed', 4, 1500),
(2, 'sea pearl beach resort', 'sea beach', '01654254289', 'Coxs bazar', 'Chittagong', 'null', ' located 40 mins from coxs bazar', 5, 5000),
(3, 'long beach hotel', 'sea beach', '01356498725', 'Chittagong', 'Chittagong', 'null', 'description not needed', 4, 3500),
(4, 'Renaissance Dhaka gulshan hotel', 'economy', '01356432598', 'Dhaka', 'null', 'null', 'description not needed', 3, 900),
(5, 'hotel tropical Daisy', 'luxury', '01865931504', 'Dhaka', 'null', 'null', 'description not needed', 4, 2000),
(6, 'Noorjahan Grand', 'luxury', '01765128953', 'Dhaka', 'null', 'null', 'description not needed', 5, 6000),
(7, 'Radisson Blue', 'luxury', '01546980956', 'Dhaka', 'null', 'null', 'description not needed', 4, 3500),
(8, 'Seagulls hotels', 'luxury', '01943287542', 'Rangpur', 'null', 'null', 'description not needed', 4, 1800),
(9, 'Intercontinental Dhaka', 'luxury', '01324378978', 'Dhaka', 'Mirpur', 'null', 'Primary place to stay for tourists', 4, 2200),
(10, 'Laguna beach hotel', 'sea beach', '01320595345', 'Jessore', 'null', 'Keshobpur', 'description not needed', 3, 1000),
(11, 'hotel 71', 'luxury', '01635575906', 'Noakhali', 'null', 'null', '#14th best value hotel', 5, 4000),
(12, 'Pan Pacific Sunargaon', 'luxury', '01768435234', 'Dhaka', 'Sunargaon', 'null', 'description not needed', 4, 1800),
(13, 'Jatra Flagship', 'luxury', '01765767573', 'Rajshahi', 'null', 'null', 'Free Cancellation,pay at stay', 4, 2000),
(14, 'Sea Crown', 'sea beach', '01681216543', 'Dhaka', 'Narayanganj', 'null', 'best sea beach hotel', 5, 5000),
(15, 'Sukhtara', 'luxury', '01565646657', 'Commilla', 'null', 'null', 'Hotel with the best security', 4, 3200),
(16, 'Greenland hotel', 'luxury', '01654325643', 'Chittagong', 'Bandarban', 'null', 'description not needed', 5, 6000),
(17, 'Romania hotel', 'luxury', '01865265435', 'Sylhet', 'Sylhet', 'null', 'description not needed', 3, 2000),
(18, 'Muscat holiday resort', 'luxury', '01924309098', 'Bogura', 'null', 'null', 'Reserve now,pay at stay', 2, 800),
(19, 'La bella Resort', 'luxury', '01789562654', 'Dhaka', 'Tejgao', 'null', 'description not needed', 4, 2300),
(20, 'Indrapuri', 'sea beach', '01765565566', 'Chittagong', 'Coxs bazar', 'null', ' located 40 mins from coxs bazar', 5, 4500);
...
DROP TABLE IF EXISTS `spot_creator`;
CREATE TABLE `spot_creator` (
...
INSERT INTO `spot_creator` (`creator_ID`, `creator_Name`, `creator_Password`, `creator_ContactNo`) VALUES
(1, 'Hiran Nandi', 'Sunshine', '018465349673'),
(2, 'Chandrashekhar Barua', 'cricket12', '017563256326'),
(3, 'Hiranmaya Hazra', 'export123', '017564656353'),
(4, 'Amitava Nag', 'asd1236', '018316531633'),
(5, 'Anirvan Sekhar', 'Season467', '018465493562'),
(6, 'Devdas Choudhry', 'sad12334', '015646513468'),
(7, 'Dwijendralal Osmani', '2356832', '017231562347'),
(8, 'Aparna Acharyya', '3216203', '019325654656'),
(9, 'Ekantika Ganguli', 'abstract', '017632161355'),
(10, 'Suravi Parveen', 'mornings', '015651359684'),
(11, 'Sushma MAmun', 'curious', '016891359532'),
(12, 'Deeptimoyee Chaudhuri', 'sadgreens', '018659234600'),
(13, 'Oormila Sharma', 'periodic', '017335115626'),
(14, 'Bipin Sen', 'smashingkiddo', '017754322213'),
(15, 'Guru Salimullah', 'seemore', '015646568987'),
(16, 'Ramesh Ghosh', 'astimegoes', '015498793216'),
(17, 'Indrajit Chakrobarty', 'create1335', '018983212654'),
(18, 'Indrashis Shonku', 'swen5675', '019321653167'),
(19, 'Bansilal Mukerji', 'westring', '017216235621'),
(20, 'Shakib Hussain', 'riven', '018162624626');
...
INSERT INTO `tourguide` (`guide_ID`, `guide_Name`, `guide_Gender`, `guide_Languages`, `guide_ContactNo`, `guide_Description`, `guide_Rating`) VALUES
(1, 'Sudeep Choudhry', 'M', 'Bangla', '01763218448', 'very knowledgeble in history', 5),
(2, 'Bhavani Chakrobarty', 'M', 'English', '01742321351', 'very fluent in English', 4),
(3, 'Eknath Majumder', 'M', 'Bangla', '01813215663', 'knows the places well', 3),
(4, 'Biharilal Sana', 'M', 'Bangla', '01931456135', 'very knowledgeble in culture', 4),
(5, 'Vishwajeet Mazumder', 'M', 'Bangla', '01763321623', 'very knowledgeble in history', 2),
(6, 'Apurva Hazra', 'M', 'Bangla', '01836321623', 'knows the places well', 4),
(7, 'Deepankar Sircar', 'M', 'Bangla', '01756235635', 'very knowledgeble in culture', 5),
(8, 'Gopalgobinda Ghoshal', 'M', 'English', '01643215434', 'very fluent in English', 5),
(9, 'Hemanga Momen', 'M', 'English', '01775123163', 'very knowledgeble in history', 3),
(10, 'Ajeet Pyne', 'M', 'Bangla', '01885462132', 'very fluent in Bangla', 1),
(11, 'Arun Goswami', 'M', 'Bangla', '01913215636', 'very knowledgeble in history', 3),
(12, 'Devidas Adhikari', 'M', 'English', '01753216237', 'Knows the place well', 4),
(13, 'Chaman Thakurta', 'M', 'Chinese', '01564859534', 'very fluent in Chinese', 5),
(14, 'Harsh Mandal', 'M', 'Bangla', '01932654621', 'very knowledgeble in history', 2),
(15, 'Tara Talukdar', 'F', 'Spanish', '01825654231', 'very knowledgeble in history', 4),
(16, 'Komal Sengupta', 'F', 'English', '01723546232', 'very knowledgeble in Culture', 4),
(17, 'Deepali Lahiri', 'F', 'Bangla', '01532565426', 'knows the place well', 4),
(18, 'Devi Chakravorty', 'F', 'Bangla', '01756238448', 'very fluent in bangla', 3),
(19, 'Anupama Chinmoy', 'F', 'Japanese', '01753218448', 'very knowledgeble in history', 5),
(20, 'Bhaavana Gayen', 'F', 'Spanish', '01532161848', 'knows spanish well', 4);
...
(1, 'Elmer Moses', 'London,England', 'English', '4347558942', 'M', 'Banker', ''),
...
(5, 'Himani Banerjee', 'Sylhet', 'Bangladeshi', '4562119621', 'F', 'IT worker', 'None'),
(6, 'Falguni Mandal', 'Chittagong', 'Bangladeshi', '9136216265', 'F', 'Politician', 'Heart Problems'),
(7, 'Dipankar Jain', 'Commilla', 'Bangladeshi', '4562136526', 'M', 'Essential worker', 'None'),
...
(10, 'Kanchana Khanum', 'Sylhet', 'Bangladeshi', '5616262136', 'F', 'Driver', 'None'),
...
(13, 'Chandrashekhar Talukdar', 'Chittagong', 'Bangladeshi', '7561669566', 'M', 'Chef', 'None'),
(14, 'Anupama Bhanja', 'Coxs bazar', 'Bangladeshi', '6562165956', 'F', 'store owner', 'None'),
(15, 'Guru Brahmachari', 'Narayanganj', 'Bangladeshi', '1565495632', 'M', 'Event organizer', 'None'),
(16, 'Kalpana Yagnik', 'Rangpur', 'Bangladeshi', '8465462165', 'F', 'Essential worker', 'None'),
(17, 'Gadhar Chakrobarty', 'Assam', 'Indian', '7654656565', 'M', 'Essential worker', 'None'),
...
(20, 'Sanjay Bachchan', 'Sylhet', 'Bangladeshi', '4899595669', 'M', 'Essential worker', 'None');
...
CREATE TABLE `tour_plan` (
  ...
  `plan_TouristID` int DEFAULT NULL,
  `plan_Start_Date` date DEFAULT NULL,
  `plan_End_Date` date DEFAULT NULL,
  `plan_Estimated_Cost` int DEFAULT NULL,
  `plan_notes` varchar(60) DEFAULT NULL,
  `plan_Tourist_Numbers` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `tour_report`;
CREATE TABLE `tour_report` (
  `report_ID` int NOT NULL,
  `plan_ID` int DEFAULT NULL,
  `report_Start_Date` date DEFAULT NULL,
  `report_End_Date` date DEFAULT NULL,
  `report_Estimated_Cost` int DEFAULT NULL,
  `report_Actual_Cost` int DEFAULT NULL,
  `report_Tourist_Numbers` int DEFAULT NULL,
...
(7, 8, '2022-04-01', '2022-04-03', 1700, 1800, 1, NULL),
...
DROP TABLE IF EXISTS `tour_report_list`;
CREATE TABLE `tour_report_list` (
  `plan_ID` int DEFAULT NULL,
...
CREATE TABLE `transport` (
  ...
  `trans_Rating` int DEFAULT NULL,
  `trans_cost` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(8, 'Green Line', 'Economy', '2022-06-12', '01968765463', 'Anywhere in Bangladesh', 4, 2000),
(9, 'Hanif Travels', 'Economy', '2022-08-15', '01698754357', 'Anywhere in Bangladesh', 5, 2500),
(10, 'Himachal Express', 'Economy', '2022-04-10', '01897657498', 'From Jessore to Sylhet', 5, 2400),
(11, 'Kornofuli Paribahan', 'Economy', '2022-10-12', '01736562356', 'Anywhere in Chittagong', 1, 400),
(12, 'Kaher Travels', 'Economy', '2022-04-15', '01654321983', 'From Dhaka to Rajshahi', 2, 700),
(13, 'Sylhet Express', 'Economy', '2022-02-01', '01565789535', 'Anywhere in Sylhet', 4, 2800),
(14, 'Coxs Bazar Paribahan', 'Economy', '2022-03-05', '01546549830', 'From Chittagong to Coxs Bazar', 4, 2200),
(15, 'Pabna Express', 'Economy', '2022-04-06', '01736546593', 'Anywhere in Pabna', 5, 3000),
(16, 'RajDhani Express', 'Economy', '2022-05-12', '01889765983', 'Anywhere in Dhaka', 3, 1300),
...
(19, 'Shanti Paribahan', 'Economy', '2022-07-12', '01635496534', 'From Rangpur to Dhaka', 3, 1000),
...
CREATE TABLE `travel_spots` (
  ...
  `spot_Zilla` varchar(40) DEFAULT NULL,
  ...
  `spot_Rating` int DEFAULT NULL,
  `spot_Price_Range` decimal(5,2) DEFAULT NULL,
  `verified` varchar(10) DEFAULT NULL,
  `spot_creator_ID` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `travel_spots` (`spot_ID`, `spot_Name`, `spot_District`, `spot_Zilla`, `spot_Upazilla`, `spot_Additional_Address_Info`, `spot_Category`, `spot_Images`, `spot_Description`, `spot_Availablility`, `spot_Transport_Method`, `spot_Rating`, `spot_Price_Range`, `verified`, `spot_creator_ID`) VALUES
(1, 'Sajek valley', 'Chittagong', 'Rangamati', 'Baghaichhari', 'Kasalong range of mountains', 'Mountains', NULL, 'hills of Kasalong mountains', 'Yes', 'ground/air', 5, '500.00', 'Yes', 5),
(2, 'Coxs Bazar', 'Chittagong', 'Chittagong', NULL, 'Longest sea beach', 'sea beach', NULL, 'reputation for swimming, and surfing', 'Yes', 'ground/air', 5, '700.00', 'Yes', 4),
(3, 'Sundarbans', 'Commilla', NULL, NULL, 'largest mangrove forest', 'Forest', NULL, 'rivers,mudflats and tiny islands', 'Yes', 'ground', 4, '600.00', 'Yes', 10),
(4, 'St. martins island', 'Chittagong', 'Coxs bazar', NULL, 'island and marine life', 'Mountains', NULL, 'cocounut palms island', 'Yes', 'ground/air', 3, '500.00', 'Yes', 2),
(5, 'Kuakata', 'Patuakhali', 'Kalapara', NULL, 'both sunrise and sunset unobstructed', 'sea beach', NULL, 'picturesque natural beauty, blue sky', 'Yes', 'ground/air', 5, '600.00', 'Yes', 8),
(6, 'Jaflong', 'Sylhet', '', NULL, 'falls cascading from green mountains', 'Mountains', NULL, '', 'Yes', 'ground/air', 4, '500.00', 'Yes', 12),
(7, 'Shat Gambuj Mosque', 'Bagerhat', '', NULL, 'Important culutural site', 'Cultural site', NULL, 'famous for size and architectural beauty', 'Yes', 'ground/air', 4, '500.00', 'Yes', 2),
(8, 'National Memorial', 'Dhaka', 'Savar', NULL, 'historic national site', 'cultural site', NULL, 'an iconic martyr structure', 'Yes', 'ground/air', 3, '500.00', 'Yes', 2),
(9, 'Sonargaon', 'Dhaka', 'Dhaka', NULL, 'old capital city', 'cultural site', NULL, 'historic trade place', 'Yes', 'ground/air', 4, '500.00', 'Yes', 4),
(10, 'Ahsan Manzil', 'Dhaka', 'Dhaka', NULL, 'historic Nawab palace', 'Cultural site', NULL, 'important cultural heritage site', 'Yes', 'ground/air', 5, '600.00', 'Yes', 6);
...
ALTER TABLE `tour_plan`
  ...
  ADD KEY `plan_TouristID` (`plan_TouristID`);
...
ALTER TABLE `travel_spots`
  ...
  ADD KEY `spot_creator_ID` (`spot_creator_ID`);
